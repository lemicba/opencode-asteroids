...
Con la nave **Gigante** activa, todos los puntos se duplican.
...
- Skins de la nave: pulsá `S` para ciclar entre 5 diseños con silueta y color propios (Clásica, Cazador, Coloso, Espectro y Gigante); la elección se guarda en el navegador y se recuerda entre sesiones
- Nave Gigante: skin morada dos veces más grande que la original (con radio de colisión a juego) que duplica todos los puntos obtenidos mientras está activa
